export const MISSING_FIELDS_REQUIRED = "Complete los campos requeridos";
export const NOT_FOUND = "Email o clave inválidos.";
export const INVALID_CREDENTIALS = "Email o clave inválidos.";
export const INVALID_PASSWORD_LENGTH =
  "La contraseña debe tener mínimo 6 caracteres";
export const DUPLICATE_RECORD = "Ya existe un usuario con ese email.";
